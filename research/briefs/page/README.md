# HTML-прототипы UI ценообразования ЯМ

Локально: `http://127.0.0.1:8765/ym-price-mgmt-ui-example.html`  
Публично (GitHub Pages, ветка `pricing`):
...
- https://fefelovandrey.github.io/RULI_YM/ym-exclusions.html
- https://fefelovandrey.github.io/RULI_YM/ym-export.html
- https://fefelovandrey.github.io/RULI_YM/ (оглавление)

Публикация: `.github/workflows/pages.yml` выкладывает эту папку как корень сайта.
